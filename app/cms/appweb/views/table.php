<div class="row"> <!-- Segunda Fila de contenidos -->
  <div class="span12">
    <p class="label label-inverse">Se econtró un total de <?php print (count($table)-1); ?> articulos en esta sección</p>
          ...
          <tbody>
            <?php
              ...
              foreach ($table as $row) {
                ...
                print $row['id_article'] . '</td> <td class="align-left span7"> <a href="'. base_url() .'index.php/' . $controller .'/present/'. $row['id_article'].'">';
    ...
    <p class="label label-inverse pull-right">Se econtró un total de <?php print (count($table)-1); ?> articulos en esta sección</p>
  </div>
